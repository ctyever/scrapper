...
def land_info(area_name, area_url):
    ...
    if info_df.empty:
        ...
        info_df = info_df[['cortarNo', '지역명', 'atclNo', 'vrfcTpCd', 'tradTpNm', 'rletTpNm', 'spc1',
                           'flrInfo', 'atclFetrDesc', 'atclCfmYmd', 'hanPrc', 'rentPrc', 'tagList', 'rltrNm', 'direction']]
        info_df = info_df.rename(
            columns={'cortarNo': '지역코드', 'atclNo': '매물코드', 'vrfcTpCd': '매물정보',
                     'tradTpNm': '매물방식', 'rletTpNm': '주거형태', 'spc1': '면적',
                     'flrInfo': '층', 'atclFetrDesc': '특이사항', 'atclCfmYmd': '확인매물', 'hanPrc': '거래가액', 'rentPrc': '월세',
